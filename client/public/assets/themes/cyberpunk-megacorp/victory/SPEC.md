# 🎵 Cyberpunk Megacorp — victory track

This folder is the drop-in location for the **victory** music track for the **Cyberpunk Megacorp** government theme.
...
- The game's `themeAudioManifest.ts` slug `cyberpunk-megacorp` will resolve to this asset.
