# 🎵 Game Show Reality — victory track

This folder is the drop-in location for the **victory** music track for the **Game Show Reality** government theme.
...
- The game's `themeAudioManifest.ts` slug `game-show-reality` will resolve to this asset.
