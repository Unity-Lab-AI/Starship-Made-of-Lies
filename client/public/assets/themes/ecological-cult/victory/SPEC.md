# 🎵 Ecological Cult — victory track

This folder is the drop-in location for the **victory** music track for the **Ecological Cult** government theme.
...
- The game's `themeAudioManifest.ts` slug `ecological-cult` will resolve to this asset.
