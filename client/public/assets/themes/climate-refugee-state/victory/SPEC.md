# 🎵 Climate Refugee State — victory track

This folder is the drop-in location for the **victory** music track for the **Climate Refugee State** government theme.
...
- The game's `themeAudioManifest.ts` slug `climate-refugee-state` will resolve to this asset.
