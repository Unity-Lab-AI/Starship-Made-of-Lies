# 🎵 Military Junta — victory track

This folder is the drop-in location for the **victory** music track for the **Military Junta** government theme.
...
- The game's `themeAudioManifest.ts` slug `military-junta` will resolve to this asset.
