# 🎵 Gerontocracy — victory track

This folder is the drop-in location for the **victory** music track for the **Gerontocracy** government theme.
...
- The game's `themeAudioManifest.ts` slug `gerontocracy` will resolve to this asset.
