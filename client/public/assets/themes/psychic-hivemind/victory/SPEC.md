# 🎵 Psychic Hivemind — victory track

This folder is the drop-in location for the **victory** music track for the **Psychic Hivemind** government theme.
...
- The game's `themeAudioManifest.ts` slug `psychic-hivemind` will resolve to this asset.
