# 🎵 Theocracy — victory track

This folder is the drop-in location for the **victory** music track for the **Theocracy** government theme.
...
- The game's `themeAudioManifest.ts` slug `theocracy` will resolve to this asset.
