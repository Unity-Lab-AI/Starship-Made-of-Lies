# 🎵 Surveillance State — victory track

This folder is the drop-in location for the **victory** music track for the **Surveillance State** government theme.
...
- The game's `themeAudioManifest.ts` slug `surveillance-state` will resolve to this asset.
