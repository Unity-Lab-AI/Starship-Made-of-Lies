# 🎵 Anarcho-Capitalist — victory track

This folder is the drop-in location for the **victory** music track for the **Anarcho-Capitalist** government theme.
...
- The game's `themeAudioManifest.ts` slug `anarcho-capitalist` will resolve to this asset.
