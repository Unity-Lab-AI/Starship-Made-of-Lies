# 🎵 Eugenics Utopia — victory track

This folder is the drop-in location for the **victory** music track for the **Eugenics Utopia** government theme.
...
- The game's `themeAudioManifest.ts` slug `eugenics-utopia` will resolve to this asset.
