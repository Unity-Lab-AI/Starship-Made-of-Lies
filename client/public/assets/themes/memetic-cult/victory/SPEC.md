# 🎵 Memetic Cult — victory track

This folder is the drop-in location for the **victory** music track for the **Memetic Cult** government theme.
...
- The game's `themeAudioManifest.ts` slug `memetic-cult` will resolve to this asset.
