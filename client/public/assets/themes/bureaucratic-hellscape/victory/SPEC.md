# 🎵 Bureaucratic Hellscape — victory track

This folder is the drop-in location for the **victory** music track for the **Bureaucratic Hellscape** government theme.

## Drop in this folder

| Filename | `victory.ogg` |
| -------- | ------------- |

Drop a single audio file here named exactly **`victory.ogg`**. Once dropped:
...
Master gain ≈ -14 LUFS integrated. Headline moment, can be loud.
