# 🎵 Pharaonic Dynasty — victory track

This folder is the drop-in location for the **victory** music track for the **Pharaonic Dynasty** government theme.
...
- The game's `themeAudioManifest.ts` slug `pharaonic-dynasty` will resolve to this asset.
