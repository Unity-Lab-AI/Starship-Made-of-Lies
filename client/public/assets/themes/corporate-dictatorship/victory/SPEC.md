# 🎵 Corporate Dictatorship — victory track

This folder is the drop-in location for the **victory** music track for the **Corporate Dictatorship** government theme.
...
- The game's `themeAudioManifest.ts` slug `corporate-dictatorship` will resolve to this asset.
