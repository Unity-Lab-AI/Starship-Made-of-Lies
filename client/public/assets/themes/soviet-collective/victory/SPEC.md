# 🎵 Soviet Collective — victory track

This folder is the drop-in location for the **victory** music track for the **Soviet Collective** government theme.
...
- The game's `themeAudioManifest.ts` slug `soviet-collective` will resolve to this asset.
