# 🎵 Warlord Confederacy — victory track

This folder is the drop-in location for the **victory** music track for the **Warlord Confederacy** government theme.
...
- The game's `themeAudioManifest.ts` slug `warlord-confederacy` will resolve to this asset.
