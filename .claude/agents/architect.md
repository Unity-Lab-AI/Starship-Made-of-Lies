...
| ARCHITECTURE.md limit | 600 lines |
...
### Task 2: UnityMissile Architecture
...
2. **UnityPad**: State machine, menus, LCDs
3. **UnityMissile**: Phases, targeting, communication
