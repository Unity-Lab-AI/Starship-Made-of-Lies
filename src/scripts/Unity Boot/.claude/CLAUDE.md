...
- `src/scripts/Unity Boot.cs` - Raw script file (edit this)
- `src/scripts/Unity Boot/Program.cs` - MDK build file (auto-wrapped)

**WHEN EDITING:**
1. Edit `src/scripts/Unity Boot.cs` directly
2. Run `tools/wrap-scripts.ps1` to sync to Program.cs
3. Build with `dotnet build "src/scripts/Unity Boot" -c Debug`
