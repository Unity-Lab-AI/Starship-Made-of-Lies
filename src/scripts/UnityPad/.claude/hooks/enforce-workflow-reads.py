#!/usr/bin/env python3
"""
ENFORCE WORKFLOW FILE READS - UNITYPAD
======================================
...
PROJECT_DIR = os.environ.get('CLAUDE_PROJECT_DIR', r'C:\Users\gfour\Desktop\Space Engineers\Unity Missile System\UnityPad')
...
REQUIRED_AGENT_FILES = [
    ...
    'agents/unity-missile.md',      # Missile-specific agent (relevant to pad)
    ...
    if total_missing == 0:
        output = {
            ...
            "hookSpecificOutput": {
                ...
                "additionalContext": f"""
[UNITYPAD WORKFLOW FILES - ALL READ] ✓
Local files: {total_local}/{total_local}
Parent files: {total_parent}/{total_parent}
Status: COMPLETE - All workflow files loaded

You may proceed with the UnityPad workflow.
Unity says: "Launch pad's primed and ready to send some ordnance!"
"""
            }
        }
    ...
    missing_report = f"""
[UNITYPAD WORKFLOW FILES - INCOMPLETE] ⚠️
