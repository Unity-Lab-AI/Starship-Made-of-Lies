...
**Location:** `Unity Missile System/UnitySignal/` (part of Unity Missile System)
...
- `UnitySignal.cs` - Raw script file (edit this)
- `UnitySignal/Program.cs` - MDK build file (auto-wrapped)

**WHEN EDITING:**
1. Edit `UnitySignal.cs` directly
2. Run `wrap-scripts.ps1` to sync to Program.cs
3. Build with `dotnet build UnitySignal -c Debug`
