...
| Constraint | Value |
|------------|-------|
| Read line count | **ALWAYS 600 lines** - Claude reads 600 lines per Read. NOT a limit, THE number. Read files first, don't grep. |
...
```
Read full file (600 lines per Read - always 600)
Identify:
...
Exists: YES/NO
Total lines: [NUMBER]
Read line count: 600 (always 600 - read files first, don't grep)
